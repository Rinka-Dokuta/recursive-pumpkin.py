...
def draw_pumpkin_spiral(x, y, width, height, depth, angle):
    ...
    pygame.draw.ellipse(screen, BLACK, (x + width * 0.2, y, width * 0.8, height), 2)
    pygame.draw.ellipse(screen, BLACK, (x + width * 0.3, y, width * 0.5, height), 2)
